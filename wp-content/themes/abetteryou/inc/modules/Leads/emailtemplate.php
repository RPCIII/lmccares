...
<head>
    ...
    <style>
        * { font-family: sans-serif; }
        h2 { color: #f7c51b; font-weight:bold; }
...
<table
    ...
    <tbody>
    <tr>
        <td style="padding:20px; border:1px solid #ddd; border-top:10px solid #f7c51b; border-bottom: 0;" >
            <h2>{headline}</h2>
            <p>{introcopy}</p>
    ...
    <tr>
        <td style="border-bottom: #3aa4aa solid 2px; border-left:1px solid #ddd; border-right:1px solid #ddd; padding:10px;">
