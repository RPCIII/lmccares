...
class Leads
{
     ...
     */
    public function handleLead ($dataSubmitted = array())
    {
        $fullName = (isset($dataSubmitted['name']) ? $dataSubmitted['name'] : null);
        $dataSubmitted['name'] = (isset($dataSubmitted['first_name']) && isset($dataSubmitted['last_name']) ? $dataSubmitted['first_name'] . ' ' . $dataSubmitted['last_name'] : $fullName);
     ...
     * @param $input
     */
    protected function assembleLeadData ($input = array())
    {
        $default = array(
            'name'     => 'Name',
    ...
    protected function sendNotifications ($leadInfo)
    {
        ...
        $fullName     = (isset($leadInfo['name']) ? $leadInfo['name'] : null);
